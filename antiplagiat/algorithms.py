...
def fileTokenizer(file, langauge):
    ...
    for token in tokens:
        ...
        elif(token.token_type==token.token_type.STRING):
...
# sunt pe fiecare rand, amprentele (ca sa le compar intre ele) cu indexul lor (fingerprints) ca sa calculez randul de pe care provin)
